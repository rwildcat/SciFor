! https://github.com/DannyVanpoucke/TimerClass.git
!
!++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
!> The TimeClass module contains the ttime TTime class used by the
!! timerclass::ttimer TTimer class for practical timing.
!!
...
module TimeClass
    ...
    !+++++++++++++++++++++++++++++++++++++++
    !! The TTime class contains all time functionality
    ...
    type, public :: TTime
      private
        ...
        real    :: daysecs ! No of secs of the day, with milliscs resolution
        
    contains
      private
        procedure, pass(this),public :: SetTime
        procedure, pass(this)        :: CalculateJDN
        procedure, pass(this)        :: SetJDN
        procedure, pass(this)        :: SetGregorianDateFromJDN
        procedure, pass(this),public :: GetJulianDayNumber
        procedure, pass(this)        :: copy
        procedure, pass(this)        :: add
        procedure, pass(this)        :: subtract
        procedure, pass(this),public :: IsLeapYear
        procedure, pass(this),public :: GetTimeString
        procedure, pass(this),public :: GetTimeSeconds
    ...
    ! This is the only way a constructor can be created
    interface TTime
...
contains
    ...
    ! Constructor for the ttime TTime class.
